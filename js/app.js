 ...
 * CONSTANTS
 */
const RULE110 = new Uint16Array([0, 1, 1, 0, 1, 1, 1, 0]);
 ...
 * CONSTANTS copies
 */
const RULE110_COPY = RULE110.slice();
...
automatonWorker.postMessage({ eventName: 'init', FIRST_YEAR_COPY, RULE110}, 
                            [ FIRST_YEAR_COPY.buffer, RULE110.buffer ]);
...
domHandlers.initRuleBtns(RULE110_COPY, (newRule) => {
